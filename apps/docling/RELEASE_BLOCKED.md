...
Source package `0.3.5-beta.4.editorial.20260915.1` is not published or qualified for a live
official catalog release. The targeted Freelove development update corrects the
folder-action mailbox with unchanged, previously qualified images. Its live folder
picker was verified; this does not close the broader release gates below.
See [editorial icons and release gates](../../docs/editorial-icons.md).
