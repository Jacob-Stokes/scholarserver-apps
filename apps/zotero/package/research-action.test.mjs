...
test("the metadata-only candidate declares one bounded runtime research action without a new caller grant", async () => {
  ...
  assert.equal(manifest.packageVersion, "0.5.10-guided.20260915.1");
  assert.deepEqual(
