...
```sh
docker build -f apps/paperless/development/PaperlessMcp.dockerfile -t scholarserver-paperless-native:20260907 .
python3 apps/paperless/development/native_probe.py
```

The draft recipe stays in this development directory until a real package and
native image-source inventory exist. It is not a distributable catalog image.
